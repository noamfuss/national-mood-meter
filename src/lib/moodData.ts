...
export const BOOM_MESSAGES = [
  "בום על קולי, חיל האוויר בדרך לעוד לקוח מרוצה",
  "זה רק האופנוע של השליח וולט",
  "מישהו טרק את הפח",
  "דלת של רכב נסגרה חזק מדי",
  "בלון שהתפוצץ במסיבת יום הולדת",
  "השכן מלמעלה שוב גורר רהיטים",
  "סתם רעם חזק, החורף פה",
  "מישהו פתח בקבוק קולה שהיה בשמש יותר מדי זמן.",
  "מישהו פוצץ שקית של במבה",
];
